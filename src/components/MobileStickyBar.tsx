...
export function MobileStickyBar({ 
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 bg-white border-t border-sage-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] transition-transform duration-300 z-50 lg:hidden ${
    ...
    >
      <div className="flex items-center gap-2 p-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium py-3.5 px-4 rounded-full transition-all duration-300 active:scale-95 min-h-[52px]"
        ...
        >
          ...
          <span className="text-sm">Add to Cart — {formatPrice(price)}</span>
        </button>
      </div>
